...
public class CodeStandardVisitor implements OpcodeVisitor {
    ...
    private static final String CP_INS_FORMAT = "%04d: %-15s #%-3s // %s\n";
    private static final String NEW_ARRAY_FORMAT = "%04d: %-15s %-4s // %s\n";
    ...
    public void visit(InstructionChain chain, byte[] code_bytes) {
