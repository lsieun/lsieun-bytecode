...
public class OpcodeStackVisitor implements OpcodeVisitor {
    // region Stack produce and consume
...
//        consume = getFieldSize(signature);
    }
...
//        consume = getFieldSize(signature) + 1;
    }
    ...
    public void visitMULTIANEWARRAY(MULTIANEWARRAY obj) {
        consume = obj.dimensions;
        produce = 1;
        count = produce - consume;
        setCount(count);
    }
