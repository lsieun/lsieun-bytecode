...
import lsieun.bytecode.opcode.utils.InstructionUtils;
...
public class OpcodeReadVisitor extends EmptyVisitor {
    ...
    public OpcodeReadVisitor(byte[] code_bytes) {
        byteDashboard = new ByteDashboard(code_bytes);
    }
    ...
    public InstructionChain getInstructionChain() {
        ...
        while (byteDashboard.hasNext()) {
            ...
            int offset = byteDashboard.getIndex();

            int opcode = byteDashboard.readUnsignedByte();
    ...
    public void visitBIPUSH(BIPUSH obj) {
        byte value = byteDashboard.readByte();
        obj.value = value;
    }
    ...
    public void visitSIPUSH(SIPUSH obj) {
        obj.length = 3;
        obj.value = byteDashboard.readShort();
    }

    @Override
    public void visitLDC(LDC obj) {
        obj.index = byteDashboard.readUnsignedByte();
    }

    @Override
    public void visitLDC_W(LDC_W obj) {
        obj.index = byteDashboard.readUnsignedShort();
    }
    ...
    public void visitIINC(IINC obj) {
        ...
        if (wide) {
            obj.length = 5;
            obj.index = byteDashboard.readUnsignedShort();
            obj.constValue = byteDashboard.readShort();
        } else {
            obj.length = 3;
            obj.index = byteDashboard.readUnsignedByte();
            obj.constValue = byteDashboard.readByte();
        }
    }

    @Override
    public void visitIFEQ(IFEQ obj) {
        obj.branch = byteDashboard.readShort();
    }
    ...
    public void visitGOTO_W(GOTO_W obj) {
        obj.branch = byteDashboard.readInt();
    }
    ...
    public void visitRET(RET obj) {
        ...
        if (wide) {
            obj.length = 4;
            obj.index = byteDashboard.readInt();
        } else {
            obj.length = 2;
            obj.index = byteDashboard.readShort();
        }
    }

    @Override
    public void visitTABLESWITCH(TABLESWITCH obj) {
        int padding = obj.padding = (4 - (byteDashboard.getIndex() % 4)) % 4; // Compute number of pad bytes
        ...
        obj.default_branch = byteDashboard.readInt();

        int low = obj.low = byteDashboard.readInt();
        int high = obj.high = byteDashboard.readInt();
        ...
        for (int i = 0; i < match_length; i++) {
            obj.matches[i] = low + i;
            obj.offsets[i] = byteDashboard.readInt();
        }
    ...
    public void visitLOOKUPSWITCH(LOOKUPSWITCH obj) {
        ...
        int npairs = obj.npairs = byteDashboard.readInt();
        ...
        for (int i = 0; i < npairs; i++) {
            obj.matches[i] = byteDashboard.readInt();
            obj.offsets[i] = byteDashboard.readInt();
        }
    }
    ...
    public void visitINVOKEINTERFACE(INVOKEINTERFACE obj) {
        obj.index = byteDashboard.readUnsignedShort();
        obj.count = byteDashboard.readUnsignedByte();
    ...
    public void visitINVOKEDYNAMIC(INVOKEDYNAMIC obj) {
        obj.index = byteDashboard.readUnsignedShort();
        byteDashboard.readUnsignedShort();
    }
    ...
    public void visitNEWARRAY(NEWARRAY obj) {
        obj.atype = byteDashboard.readByte();
        obj.length = 2;
    }
    ...
    public void visitMULTIANEWARRAY(MULTIANEWARRAY obj) {
        obj.length = 4;
        obj.index = byteDashboard.readUnsignedShort();
        obj.dimensions = byteDashboard.readUnsignedByte();
    }
